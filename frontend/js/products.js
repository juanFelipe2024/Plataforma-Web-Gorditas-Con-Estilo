  ...
  let lista =
    categoriaActual === "todas"
      ...
      : todosLosProductos.filter(
          (p) => p.categoria?.toLowerCase() === categoriaActual.toLowerCase(),
        );
...
function productoCardHTML(producto) {
  ...
  // tallas es ahora array de objetos { talla, stock }
  ...
  return `
        <div class="producto-card ${agotado ? "producto-agotado" : ""}"
            ...
            <div class="producto-info">
                ...
                <p class="producto-tallas">Tallas disponibles: ${tallasTexto}</p>
            </div>
        </div>
    `;
}
